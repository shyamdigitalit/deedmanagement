...
export const DEED_COLUMNS = [
    ...
    { field: 'tcNo', headerName: 'TC Number', width: 250 },
    { field: 'gpNo', headerName: 'Gate Pass', width: 150 },
    { field: 'poNo', headerName: 'PO', width: 100 },
    { field: 'grnNo', headerName: 'GRN', width: 80 },
